...
<div class="card-body"> 
      ...
      @endif
      <div class="container"> 
          <h2>Gerenciamento de Matrículas</h2><br> 
          <a href="/Matricula/create" class='btn btn-outline-info col-2'>
          <b>Cadastro de Matrículas</b></a><br><br><br> 
        <table id="matriculas" class="table table-bordered table-hover"> 
          <thead> 
            <tr> 
              <th>ID</th> 
              <th>Curso</th> 
