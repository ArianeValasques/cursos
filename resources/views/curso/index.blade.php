...
<div class="card-body"> 
      ...
      @endif
      <div class="container"> 
          <h2>Gerenciamento de Cursos</h2><br> 
          <a href="/Curso/create" class='btn btn-outline-info col-2'>
          <b>Cadastro de Cursos</b></a><br><br><br> 
        <table id="cursos" class="table table-bordered table-hover"> 
          <thead> 
            <tr> 
              <th>ID</th> 
              <th>Nome</th> 
